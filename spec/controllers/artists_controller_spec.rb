...
describe ArtistsController do
  ...
  let(:valid_attributes) { { "fund_sender_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved artist as @artist" do
        ...
        post :create, {:artist => { "fund_sender_id" => "invalid value" }}, valid_session
        assigns(:artist).should be_a_new(Artist)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested artist" do
        ...
        Artist.any_instance.should_receive(:update_attributes).with({ "fund_sender_id" => "1" })
        put :update, {:id => artist.to_param, :artist => { "fund_sender_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the artist as @artist" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Artist.any_instance.stub(:save).and_return(false)
        put :update, {:id => artist.to_param, :artist => { "fund_sender_id" => "invalid value" }}, valid_session
        assigns(:artist).should eq(artist)
      end
