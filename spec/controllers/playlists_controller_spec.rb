...
describe PlaylistsController do
  ...
  let(:valid_attributes) { { "playlist_id" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved playlist as @playlist" do
        ...
        post :create, {:playlist => { "playlist_id" => "invalid value" }}, valid_session
        assigns(:playlist).should be_a_new(Playlist)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested playlist" do
        ...
        Playlist.any_instance.should_receive(:update_attributes).with({ "playlist_id" => "MyString" })
        put :update, {:id => playlist.to_param, :playlist => { "playlist_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the playlist as @playlist" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Playlist.any_instance.stub(:save).and_return(false)
        put :update, {:id => playlist.to_param, :playlist => { "playlist_id" => "invalid value" }}, valid_session
        assigns(:playlist).should eq(playlist)
      end
